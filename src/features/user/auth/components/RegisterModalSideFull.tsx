...
export default function RegisterModalSideFull({ isOpen, setIsOpen }: RegisterModalProps) {
    ...
    >
      ...
      >
        <div className="hidden md:block md:w-1/2 h-80 md:h-auto">
          <img src={coverImage} alt="Register Cover" className="w-full h-full object-cover" />
        </div>
