...
export const adminRoutes = (
  <>
    ...
    <Route path={ADMIN_ROUTES.ROOT} element={
      <AdminProtectedRoute>
        <AdminLayout />
      </AdminProtectedRoute>
    }>
      ...
      {/* Destinations */}
      <Route path={relative(ADMIN_ROUTES.DESTINATIONS)} element={<DestinationsPage />} />
      <Route path={relative(ADMIN_ROUTES.ADD_DESTINATION)} element={<AddDestinationPage />} />
      <Route path={relative(ADMIN_ROUTES.EDIT_DESTINATION())} element={<EditDestinationPage />} />
      
      {/* Transportations */}
      <Route path={relative(ADMIN_ROUTES.TRANSPORTATIONS)} element={<TransportationsPage />} />
      <Route path={relative(ADMIN_ROUTES.ADD_TRANSPORTATION)} element={<AddTransportationPage />} />
      <Route path={relative(ADMIN_ROUTES.EDIT_TRANSPORTATION())} element={<EditTransportationPage />} />
      ...
      <Route path={relative(ADMIN_ROUTES.EDIT_HOTEL())} element={<EditHotelPage />} />
